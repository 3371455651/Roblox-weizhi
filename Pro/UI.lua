...
function Ripple(obj)
	spawn(function()
		...
		Ripple.ZIndex = 8
		Ripple.Image = "rbxassetid://127981401233034" --图标
...
if theme == 'dark' then
    ...
    beijingColor = Color3.fromRGB(25, 25, 25)
      ...
      DropShadow.Image = "rbxassetid://114036323922753" --背景
...
Open.Active = true
Open.Draggable = true
Open.Image = "rbxassetid://92272999734904"
Open.MouseButton1Click:Connect(function()
  Main.Visible = not Main.Visible
  Open.Image = Main.Visible and "rbxassetid://92272999734904" or "rbxassetid://127981401233034" --开关的图
end)
...
UIG.Parent = Open
      ...
      function window.Tab(window, name, icon)
        ...
        TabIco.Image = "rbxassetid://92272999734904" or icon and "rbxassetid://"..icon    --Tab图标
